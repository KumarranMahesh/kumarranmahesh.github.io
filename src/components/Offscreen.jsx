...
export default function Offscreen() {
    return (
        <section
            className="bg-black text-white dark:bg-white dark:text-black border-y-4 border-black dark:border-white py-24 px-6 relative overflow-hidden scroll-mt-20"
            id="offscreen"
        >
            {/* Decorative SVG */}
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center relative z-10">
                <div className="md:w-1/2">
                    <h2 className="text-6xl md:text-8xl font-black uppercase leading-none mb-6">
                        The
                        <br />
                        Off
                        <br />
                    ...
                    <p className="mono-text text-lg mb-8 text-gray-400 dark:text-gray-600">
                ...
                <div className="md:w-1/2 w-full grid gap-6">
                    {BLOG_POSTS.map((post) => (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="border-2 border-white dark:border-black p-6 hover:border-primary dark:hover:border-primary transition-colors group cursor-pointer block no-underline text-inherit"
                        >
